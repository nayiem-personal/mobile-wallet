...
var BlockStatus = (function () {
    ...
    __decorate([
        json_typescript_mapper_1.JsonProperty('success'),
        __metadata("design:type", Boolean)
    ], BlockStatus.prototype, "success", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('epoch'),
        __metadata("design:type", Date)
    ], BlockStatus.prototype, "epoch", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('height'),
        __metadata("design:type", Number)
    ], BlockStatus.prototype, "height", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('fee'),
        __metadata("design:type", Number)
    ], BlockStatus.prototype, "fee", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('milestone'),
        __metadata("design:type", Number)
    ], BlockStatus.prototype, "milestone", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('nethash'),
        __metadata("design:type", String)
    ], BlockStatus.prototype, "nethash", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('reward'),
        __metadata("design:type", Number)
    ], BlockStatus.prototype, "reward", void 0);
    __decorate([
        json_typescript_mapper_1.JsonProperty('supply'),
        __metadata("design:type", Number)
    ], BlockStatus.prototype, "supply", void 0);
    return BlockStatus;
}());
